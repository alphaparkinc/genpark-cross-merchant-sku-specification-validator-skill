# genpark-cross-merchant-sku-specification-validator-skill
...
> **GenPark AI Agent Skill** -- Cross-merchant SKU specification validator & compatibility check (Amazon Rufus)
